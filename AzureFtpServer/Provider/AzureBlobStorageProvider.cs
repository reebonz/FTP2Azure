...
namespace AzureFtpServer.Provider {
    ...
    public sealed class AzureBlobStorageProvider
    {
        ...
        public bool DeleteFile(string path)
        {
            ...
            var b = _container.GetBlobReference(blobPath);
            if (b != null)
            {
                // Need AsyncCallback?
                b.Delete();
        ...
        public AzureCloudFile GetBlobInfo(string path, bool isDirectory)
        {
            ...
            try
            {
                if (isDirectory)
                {
                    var bDir = _container.GetDirectoryReference(blobPath);
                ...
                else
                {
                    ...
                    {
                        Uri = b.Uri,
                        LastModified = b.Properties.LastModified?.DateTime ?? DateTime.UtcNow,
